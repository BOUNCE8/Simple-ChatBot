    ...
    $(document).ready(function(){
      ...
      function showMessages(msg) {
        if (msg.authorId) user(msg.content, msg.timestamp )
        else bot(msg.content, msg.timestamp)
      ...
      output = ($input) => {
        ...
        bot(result, $time, postMessage(botInput),scrollDown());
        user($input, $time, postMessage(userInput),scrollDown());
      }
